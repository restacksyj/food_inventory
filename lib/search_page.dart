...
Widget foodItemTile(QueryDocumentSnapshot food,int index){
  ...
  Widget foodItemTileLayout(QueryDocumentSnapshot food,int index){
    return InkWell(
          ...
          onDoubleTap: () => deleteFromDB(food),
          child: Container(
            decoration: BoxDecoration(
              color: index.isOdd ? Color.fromRGBO(0,0,0,0.06):Colors.white
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(width:230.0,child: SingleChildScrollView(
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text:"Qty: ${food.get("qty").toString()}",
                      style: TextStyle(
                        color: food.get("qty")==0?Colors.red[400]:Colors.black,
                        fontFamily: "Manrope",
            ...
            Visibility(child: Text("* Needs to be stocked",style: TextStyle(
